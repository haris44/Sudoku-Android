...
import com.example.alex.sudoku.vGrille;

import java.util.ArrayList;

public class GrilleAdapter extends BaseAdapter {

    private Context context;
    private ArrayList<vGrille> items;

    public GrilleAdapter(Context context, ArrayList<vGrille> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        text1.setText(items.get(position).num + "   niveau:" + (double) items.get(position).lvl);
